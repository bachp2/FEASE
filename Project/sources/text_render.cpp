...
void TextPainter::_initfont()
{
	...
	parse_bm_font_descriptor(FPATH(resources/ms_font.txt), &font.characters);
...
void TextPainter::writeBitmap(std::string str, int px, int py)
{
	...
	//testing
	Character chr = font.characters['F'];
	...
	text_vertices.push_back({200,150,0,0,1});*/
	...
	//		text_vertices.push_back({q.x0,0.0f,q.y0,q.s0,q.t0});
	//		/*text_vertices.push_back({xad+chr.width,float(py), 0.0f, chr.x+chr.width,chr.y});
	//		text_vertices.push_back({xad+chr.width,float(py)+chr.height, 0, chr.x+chr.width,chr.y+chr.height});
	//		text_vertices.push_back({xad,float(py)+chr.yoffset, 0.0f, chr.x,chr.y+chr.height});*/
	//		text_vertices.push_back({q.x1,0.0f,q.y0,q.s1,q.t0});
	//		text_vertices.push_back({q.x1,0.0f,q.y1,q.s1,q.t1});
	//		text_vertices.push_back({q.x0,0.0f,q.y1,q.s0,q.t1});
	//		xad += chr.xadvance;
	//	}
	//	++text;
	//}
